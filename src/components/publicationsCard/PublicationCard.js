    ...
    <div
      ...
      <Fade bottom duration={2000} distance="40px">
        ...
        <div className="row">
            ...
            <div className="work-box"  style={{ backgroundColor: theme.workBox }}>
                 <div className="work-img">

            <img src={require(`../../assests/images/${repo.img1}`)} alt="" className="img-fluid" />
               

  
             <img src={require(`../../assests/images/${repo.img2}`)} alt="" className="img-fluid" />
